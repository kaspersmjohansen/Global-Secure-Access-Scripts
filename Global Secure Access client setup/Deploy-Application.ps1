...
Try {
    ...
    [String]$appScriptDate = '24/02/2025'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        # Configure Prefer IPv4 - https://learn.microsoft.com/en-us/entra/global-secure-access/troubleshoot-global-secure-access-client-diagnostics-health-check#ipv4-preferred
        Set-RegistryKey -Key 'HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters' -Name 'DisabledComponents' -Type 'DWord' -Value '32'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'iexplore' -CloseAppsCountdown 30
        ...
        Execute-Process -Path 'GlobalSecureAccess*.exe' -Parameters "/uninstall /quiet /norestart /log `"$configToolkitLogDir\$($appVendor+"_"+$appName+"_"+"Uninstall"+".log")`""
